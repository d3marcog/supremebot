...
def order():
    ...
    driver.find_element_by_xpath('//*[@id="order_billing_name"]').send_keys(keys['demarco grayson'])
    driver.find_element_by_xpath('//*[@id="order_email"]').send_keys(keys['d3marcog@yahoo.com'])
    driver.find_element_by_xpath('//*[@id="order_tel"]').send_keys(keys['2059190507'])
    driver.find_element_by_xpath('//*[@id="bo"]').send_keys(keys['2920 dowell ave sw'])
    driver.find_element_by_xpath('//*[@id="order_billing_zip"]').send_keys(keys['35211'])
    driver.find_element_by_xpath('//*[@id="order_billing_city"]').send_keys(keys['Birmingham'])
